<header class="header" id="header" role="banner">
    <div class="header-inner">
        <a href="<?= base_url($langurl); ?>" title="首页" rel="home" class="header__logo" id="logo"><img
                    src="<?= $config['site_templateurl']; ?>/sites/default/files/ibi_logo_1.png" alt="首页"
                    class="header__logo-image"/></a>
        <div class="header__region region region-header">
            <div id="block-tb-megamenu-main-menu" class="block block-tb-megamenu first last odd">
                <div class="language"><a href="#">CH</a>&nbsp;|&nbsp;<a href="<?=site_url('category/'.$category['dir'].'?lang=en');?>">EN</a></div>
