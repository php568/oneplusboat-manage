                ...
                <div class="views-field views-field-field-photo-image">
                    <div class="field-content">
                        <a href="<?=site_url('category/news'.$langurl);?>">
                            <img typeof="foaf:Image" src="<?=$config['site_templateurl'];?>/sites/default/files/news.jpg" width="270" height="175" alt="2019 New Year Greetings" />
                        </a>
                    </div>
                </div>
                <div class="views-field views-field-title">
                    <span class="field-content"><a href="<?=site_url('category/news'.$langurl);?>">2019 New Year Greetings</a></span>
                </div>
            </div>
        </div>
    </div>
