...
<style>
    ...
    @media screen and (min-width:321px) and (max-width:375px){
        .front .sidebars .sidebar{top:1010px !important;}
        .front #page {min-height:1770px;}
    ...
    @media screen and (min-width:640px) and (max-width:719px){
        .front .sidebars .sidebar{top: 3270px !important;}
        .front #page {min-height: 4080px;}
        .front .region-bottom {height: 275px;}
    }
